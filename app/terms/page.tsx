...
const Terms = () => {
	return (
		<>
			<Navbar />
			<main className="mx-auto max-w-7xl px-5 text-white space-y-2 my-12">
				<h1>Terms and Conditions</h1>
				<p>Last updated: Jun 24, 2023</p>
				<p>
				...
				<ul>
					...
					<li>
						<p>
							<strong>Country</strong> refers to: Tennessee,
							United States
						</p>
					</li>
					<li>
					...
					<li>
						<p>
							<strong>Website</strong> refers to Icon Generator
							AI, accessible from{" "}
				...
				<p>
					...
					shall not effect a party&quot;s ability to exercise such
				...
				<ul>
					<li>By email: kadertabish@gmail.com</li>
				</ul>
			</main>
			<Footer />
		</>
